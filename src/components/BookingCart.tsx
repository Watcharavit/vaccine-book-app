	...
	return (
		<div>
			<div className="bg-slate-200 rounded px-8 mx-8 py-5 my-5">
				...
				<div className="text-md">Vaccination Date: {bookItem.date}</div>
				<button className="bg-white border font-semibold py-2 px-2 m-2 rounded hover:bg-cyan-700 hover:text-white" onClick={() => dispatch(removeBooking(bookItem))}>
					Remove reservation
				</button>
			</div>
		</div>
